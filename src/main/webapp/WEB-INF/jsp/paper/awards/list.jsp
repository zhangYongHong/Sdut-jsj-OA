        ...
        <div class="navbar-inner">
            <div class="container-fluid">
                ...
                <div class="nav-no-collapse">
                    <ul class="nav">
                        <li class="active"><a href="index.html"><span class="icon16 icomoon-icon-screen-2"></span>
                            仪表</a></li>
                        <!--信息相关模块-->
                        <li class="dropdown">
            ...
            <div class="mainnav">
                <ul>
                    ...
                    <li>
                        ...
                        <ul class="sub">
                            <li><a href="#"><span class="icon16 icomoon-icon-file"></span>数据字典管理</a></li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="sub">
                            <li>
                                ...
                                <ul class="sub">
                                    ...
                                    <li><a href="#"><span class="icon16 icomoon-icon-arrow-right-2"></span>实训归档管理</a>
                                    </li>
                                </ul>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="sub">
                            <li><a href="#"><span class="icon16 icomoon-icon-address-2"></span>用户列表</a></li>
                            <li><a href="#"><span class="icon16 icomoon-icon-user-3"></span>个人信息</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
