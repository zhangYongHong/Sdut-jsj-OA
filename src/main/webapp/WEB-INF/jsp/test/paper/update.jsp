            ...
            <div class="span8">
                ...
                <div class="box">
                    ...
                    <div class="content">
                        ...
                        <form id="form-awards" class="form-horizontal" action="p_update" method="post"
                              enctype="multipart/form-data">
                            <s:hidden name="uuid" value="%{#paper.uuid}"/>
                            <div class="form-row row-fluid">
                                <div class="span9">
                                    <div class="row-fluid">
                                        <label class="form-label span4" for="title">论文题目:</label>
                                        <input class="span5" id="title" type="text" name="title" value="<s:property value="#paper.title"/>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                <div class="span9">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span5" id="author" type="text" name="author" value="<s:property value="#paper.author"/>" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                <div class="span9">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span5" id="particpants" type="text" name="particpants" value="<s:property value="#paper.particpants"/>" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                ...
                                <div class="span9">
                                    <div class="row-fluid">
                                        ...
                                        <input class="laydate-icon span5 focused " id="publishedDate" type="text" name="publishedDate"
                                             value="<s:property value="#paper.publishedDate"/>"  onclick="laydate()" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                            ...
                            <div class="form-row row-fluid">
                                <div class="span9">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span5" id="volumePeriod" type="text" name="volumePeriod" value="<s:property value="#paper.volumePeriod"/>" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                            ...
                            <s:hidden name="schoolYear" value="%{#paper.schoolYear}"/>
                            <s:hidden name="annex" value="%{#paper.annex}"/>
