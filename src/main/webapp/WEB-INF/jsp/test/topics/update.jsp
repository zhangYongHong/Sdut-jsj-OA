        ...
        <div class="row-fluid offset2">
            ...
            <div class="span8">
                ...
                <div class="box">
                    ...
                    <div class="content">
                        <form id="form-awards" class="form-horizontal" action="topics_update" method="post"
                              enctype="multipart/form-data">
                            <div class="form-row row-fluid">
                                <div class="span9">
                                    <div class="row-fluid">
                                        <label class="form-label span4" for="name">项目名称:</label>
                                        <input class="span5" id="name" type="text" name="name" value="<s:property value="#topics.name"/>" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                <div class="span9">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span5" id="type" type="text" name="type" value="<s:property value="#topics.type"/>" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                <div class="span9">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span5" id="principal" type="text" name="principal" value="<s:property value="#topics.principal"/>" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                <div class="span9">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span5" id="member" type="text" name="member" value="<s:property value="#topics.member"/>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                <div class="span9">
                                    <div class="row-fluid">
                                        ...
                                        <input class="laydate-icon span5 focused " id="startTime" type="text" name="startTime" onclick="laydate()" value="<s:property value="#topics.startTime"/>" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                <div class="span9">
                                    <div class="row-fluid">
                                        ...
                                        <input class="laydate-icon span5 focused " id="endTime" type="text" name="endTime" onclick="laydate()" value="<s:property value="#topics.endTime"/>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                <div class="span9">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span5" id="evaluate" type="text" name="evaluate" value="<s:property value="#topics.evaluate"/>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
                                <div class="span9">
                                    <div class="row-fluid">
                                        ...
                                        <input class="span5" id="gradation" type="text" name="gradation" value="<s:property value="#topics.gradation"/>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row row-fluid">
